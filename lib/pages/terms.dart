...
class _TermsState extends State<Terms> {
  ...
  final List<Widget> _pages = [
    Image.asset(
      'assets/img/backgrounds/one.png',
      fit: BoxFit.cover,
    ),
    Image.asset(
      'assets/img/backgrounds/two.png',
      fit: BoxFit.fitWidth,
    ),
    Image.asset(
      'assets/img/backgrounds/three.png',
      fit: BoxFit.cover,
    ),
  ];
...
We are Aniboy ('Company', 'we', 'us', or 'our'), a company registered in India at India, Chhattisgarh / Raipur, Raipur, Chhattisgarh .

We operate the mobile application Aniboy (the 'App'), as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') (collectively, the 'Services').

Aniboy does not store any files on our server, we only linked to the media which is hosted on 3rd party services.

You can contact us by email at knightapis123@gmail.com or by mail to India, Chhattisgarh / Raipur, Raipur, Chhattisgarh , India.

These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and Aniboy, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: knightapis123@gmail.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
...
These Legal Terms shall be governed by and defined following the laws of India. Aniboy and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
...
Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be three (3). The seat, or legal place, or arbitration shall be Bangalore, India. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of India.
...
These terms of use were created using Termly's Terms and Conditions Generator.'''),
        ...
        Padding(
          ...
          child: Text(
            'Aniboy does not store any files or any kind of information about you, on our server, we only linked to the media which is hosted on 3rd party services. ',
